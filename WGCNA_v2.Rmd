...
metadata <- read.csv("./example/metadata.csv", header = TRUE)
counts_t_filtered <- read.csv("./example/input.csv", row.names = 1, header = TRUE)
phylo <- read.csv("./example/phylo.csv")
```
